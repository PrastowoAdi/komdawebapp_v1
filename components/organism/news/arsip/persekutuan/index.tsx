...
interface PersekutuanProps {
    href: string;
}
export default function Persekutuan(props: PersekutuanProps) {
  const { href = "/" } = props;
  return (
    <section id="arsipPersekutuan" className="pb-2 dark:bg-zinc-900">
      <div className="container">
        <div className="flex flex-wrap">
          <div className="px-4 mx-auto lg:w-1/2">
            <div className="mt-10">
              <img src="/img/arsipfoto-1.svg" alt="hero-bg" className="max-w-[300px] lg:max-w-[320px] mx-auto w-80 lg:w-80 " />
            </div>
          </div>
